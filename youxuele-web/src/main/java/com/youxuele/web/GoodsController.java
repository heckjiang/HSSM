package com.youxuele.web;

import com.youxuele.dto.BaseResult;
...
public class GoodsController {
    ...
    @RequestMapping(value = "/{goodsId}/buy", method = {RequestMethod.GET, RequestMethod.POST},produces = {"application/json;charset=UTF-8"})
    @ResponseBody
